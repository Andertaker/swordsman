...
DATABASES = {
    'default': {
        ...
        #'NAME': '/home/dmitry/remote_projects/swordsman/mech_db.sqlite',                    # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(PROJECT_PATH, "root_static")
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_PATH, "static/mech"),
)
